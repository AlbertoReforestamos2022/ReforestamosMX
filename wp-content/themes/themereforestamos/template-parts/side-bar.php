<div class="position-sticky p-2">
        <h2 class="text-center text-light fw-semibold my-4">¿Qué está pasando en nuestras redes sociales?</h2>
        ...
        <div class="container twitter">
            <div class="row">
                <div class="col">
                    ...
                    <a class="twitter-timeline" href="https://twitter.com/ReforestamosMx?ref_src=twsrc%5Etfw" data-tweet-limit="3">Tweets by ReforestamosMx</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                </div>
            </div>
        </div>
